  ...
  template: `
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body" *ngIf="showExplanation">
        <p>
          Una <a href="https://academy.bit2me.com/que-es-hash/" target="_blank">función hash</a>
        ...
        <p>
          ...
          <code>be95feded82029acd290e2f9bf3e0dd8e21922c9ce045120ed4e0cff0ae69063</code>. No importa
          cuántas veces lo escribas, siempre obtendrás el mismo hash. ¡Pruébalo!
        </p>
      </div>
    </div>
